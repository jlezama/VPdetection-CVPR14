% ALIGNMENTS_FAST Point alignment detection with endpoint candidates.
% detections = ALIGNMENTS_FAST(input_points, candidate_points, xsize, ysize, epsilon, min_width, locality, min_k, length_ratio);
...
% -req: candidate_points | Candidate endpoints (Nx2 matrix).
